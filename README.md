...
3.Dashboard calculates total income, total expenses, and balance.

4.Premium features require payment via M-PESA:

STK Push sent to user phone
Payment confirmation unlocks premium features 5.Dashboard updates dynamically based on user data and premium status.
